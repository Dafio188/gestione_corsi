...
from models import db, User, Corso, Iscrizione, Test, RisultatoTest, Attestato, Progetto
...
@role_required(['admin'])
def admin_dashboard():
    discenti_count = User.query.filter_by(ruolo='discente').count()
    docenti_count = User.query.filter_by(ruolo='docente').count()
